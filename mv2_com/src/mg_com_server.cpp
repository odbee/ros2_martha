...
int main(int argc, char **argv)
{
  ...
  std::shared_ptr<rclcpp::Node> move_group_node = rclcpp::Node::make_shared("movepose_server", "", node_options);
  ...
  moveit::planning_interface::PlanningSceneInterface planning_scene_interface;
    ...
    // move_group_node->create_service<mv2_com_interfaces::srv::MovePose>("movepose", &add);
